param(
  ...
  [string]$TargetFolder = "Techno-Minds-v60.5.0-GitHub"
)
...
Write-Host "Replacing repository files with Techno Minds V60.5.0 while preserving .git..." -ForegroundColor Cyan
