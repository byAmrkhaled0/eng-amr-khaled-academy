...
try {
  ...
  Set-Content -LiteralPath $SuccessFile -Value "V63.0.1" -Encoding ASCII
  Remove-Item -LiteralPath $StateFile -Force -ErrorAction SilentlyContinue
  Write-Host "Deployment V63.0.1 completed successfully. No GitHub push was performed." -ForegroundColor Green
  exit 0
} catch {
  Write-Host "" 
