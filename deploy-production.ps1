...
try {
  ...
  Set-Content -LiteralPath $SuccessFile -Value "V62.5.0" -Encoding ASCII
  Remove-Item -LiteralPath $StateFile -Force -ErrorAction SilentlyContinue
  Write-Host "Deployment V62.5.0 completed successfully. No GitHub push was performed." -ForegroundColor Green
  exit 0
} catch {
  Write-Host "" 
