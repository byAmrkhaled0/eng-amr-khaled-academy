...
for (const htmlFile of htmlFiles) {
  ...
  if (!html.includes('assets/v61-design.css?v=63.0.1')) {
...
if (!appSourceCode.includes("MF_ASSET_VERSION = '63.0.1'")) fail('Lazy asset loader version is stale');
...
if (!/technominds-v63-0-1-production-fixed/.test(sw) || !sw.includes('/assets/v61-design.css') || !sw.includes('/assets/v53-upgrades.js') || !sw.includes('/assets/curriculum-student.js') || !sw.includes('/assets/technominds-logo.png') || !sw.includes('/practical.html') || !sw.includes('/learning-path.html') || !sw.includes('/about.html')) fail('Service worker app shell is incomplete');
