...
if (!appSourceCode.includes("MF_ASSET_VERSION = '67.2.0'")) fail('Lazy asset loader version is stale');
...
if (!/technominds-v67-2-0-assessment-ux/.test(sw) || !sw.includes('/assets/v61-design.css') || !sw.includes('/assets/v67-learning-hub.css') || !sw.includes('/assets/v53-upgrades.js') || !sw.includes('/assets/curriculum-student.js') || !sw.includes('/assets/technominds-logo.png') || !sw.includes("'/practical.html'") || !sw.includes('/learning-path.html') || !sw.includes('/about.html')) fail('Service worker app shell or sensitive portal exclusions are incomplete');
