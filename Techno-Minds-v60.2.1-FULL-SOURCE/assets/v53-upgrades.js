(function(){
  ...
  const studentHelpItems=[
    ...
    {q:'إيه المسارات المتاحة؟',keys:'مسارات برمجة بايثون ذكاء اصطناعي ثانوي مبتدئين',a:'متاح مسار تانية ثانوي، المبتدئين، أساسيات Python، والتطبيقات والمراجعة.'},
    ...
    {q:'أشغّل الكود منين؟',keys:'عملي محرر كود تشغيل run python javascript c java',a:'المعمل العملي مفتوح للجميع بدون كود طالب، ويدعم Python وJavaScript وTypeScript وC وC++ وJava وC# وGo وPHP.',link:'practical.html',label:'فتح المعمل العملي'},
