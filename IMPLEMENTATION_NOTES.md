# Eng Amr Khaled Programming Academy - Production Update v39
...
- Student and parent portals both use the unified eight-digit `studentCode`; access is resolved by a Cloud Function without exposing private student data publicly.
...
- تم استبدال الاعتماد الخارجي بماسح QR محلي يُحمّل عند الحاجة، مع BarcodeDetector وjsQR كمسارين احتياطيين.
...
- Parent monthly report was redesigned for mobile and now clearly shows teacher name: بشمهندس عمرو خالد.
