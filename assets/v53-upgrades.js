(function(){
  ...
  const studentHelpItems=[
    ...
    {q:'إيه المسارات المتاحة؟',keys:'مسارات برمجة بايثون ذكاء اصطناعي ثانوي مبتدئين',a:'متاح أولى ثانوي بكالوريا، وتانية ثانوي بكالوريا، وأساسيات برمجة، ومبتدئين برمجة.'},
