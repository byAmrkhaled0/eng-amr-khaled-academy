...
function renderPaperExamPanel(){
  if(!paperExamState.open)return `<button type="button" class="btn ghost" onclick="openPaperExamGrades()">إضافة امتحان ورقي</button>`;
...
window.openPaperExamGrades=function(id=''){paperExamState.open=true;paperExamState.examId=id;paperExamState.exam=id?(adminData.exams||[]).find(row=>row.id===id&&row.assessmentMode==='paper')||null:null;renderExams();};
