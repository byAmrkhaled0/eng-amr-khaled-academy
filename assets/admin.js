...
function calcStudentAdmin(st){const report=st.monthlyReport;if(!compatibleMonthlyReport(report,stCode(st))||report.monthKey!==adminReportMonthKey())return {attendancePct:null,avg:null,homeworkPct:null,recitationPct:null};return {attendancePct:report.attendance?.percentage??null,avg:report.results?.average??null,homeworkPct:report.homework?.completionPercentage??null,recitationPct:null};}
