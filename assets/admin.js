...
async function loadAccurateMonthlyReport(st){if(!window.MFCloud?.getStudentMonthlyReportAdmin)throw new Error('Monthly report service unavailable');return window.MFCloud.getStudentMonthlyReportAdmin({studentCode:stCode(st),monthKey:adminReportMonthKey(),force:true});}
